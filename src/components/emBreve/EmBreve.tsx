        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="bg-fuchsia-600 text-white rounded-3xl shadow-2xl p-10 flex flex-col sm:flex-row items-center gap-10">
                ...
                <div className="flex flex-col gap-6 w-full sm:w-2/3">
                    <h2 className="text-5xl font-semibold drop-shadow-md text-white">
                        Em Breve
                    </h2>
                    ...
                    <ul className="list-disc pl-6 text-white text-lg leading-relaxed font-semibold flex flex-col gap-3">
                        <li>
